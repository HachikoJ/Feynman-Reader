...
describe('TokenDanceWelcome', () => {
  ...
  it('explains the conditional offer without forcing API authorization', () => {
    ...
    expect(screen.getByText(/路由到其他端口时不保证优惠/)).toBeInTheDocument()
  ...
  it('provides the same disclosure in English', () => {
    ...
    expect(screen.getByText(/Savings are not guaranteed/)).toBeInTheDocument()
